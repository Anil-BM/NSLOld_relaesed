...
public class DetailledActivtylist2 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailled_activtylist2);
        ...
        tv_formers1.setText("Count : "+(favouriteItem.get(0).get("no_of_farmers")+" farmers ("
                +favouriteItem.get(0).get("total_expences")+" Rs)"));
        ...
        LinearLayoutManager llm = new LinearLayoutManager(DetailledActivtylist2.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void showCommentsDialog(final String order_id, final View button_view, final int i) {
        ...
        buttonOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utility.isNetworkAvailable(DetailledActivtylist2.this, true))
                {
...
//                }
    ...
    private class ApproveOrRejectAsyncTask extends AsyncTask<Object, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(DetailledActivtylist2.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent it=new Intent(DetailledActivtylist2.this, FieldActivity.class);
