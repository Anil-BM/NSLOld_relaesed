...
public class Main2Activity extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    DatabaseHandler db;
    ArrayList<MarkerData2> markerPoints;
    LatLng point;
    MapboxMap mapboxMap;
...
/*
      ...
      development*/
        ...
        checkin_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    if (Common.haveInternet(Main2Activity.this)) {
                        if (meterReadingCheckInImg != null && meterReadingCheckInImg.length() > 10)
                            ImagepopUp(null, meterReadingCheckInImg);
                        else
                            Common.customToast(Main2Activity.this, "Image not available..");
                    } else {
                        Common.customToast(Main2Activity.this, Common.INTERNET_UNABLEABLE);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        // Initializing
        markerPoints = new ArrayList<MarkerData2>();
...
*//*
                            displayGoogleLocationSettingPage(Main2Activity.this, REQUEST_CHECK_SETTINGS);
                            return true;
                        }
                    });
                }
        ...
        et_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(Main2Activity.this, new DatePickerDialog.OnDateSetListener() {
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        ...
                        if (datePickerDate.after(new Date())) {
                            ...
                            Toast.makeText(Main2Activity.this, "Please select current or previous date", Toast.LENGTH_SHORT).show();
                        } else {
                            //// map.clear(); place here
                            mapboxMap.clear();
                            markerPoints.clear();
                            ...
                            try {
                                if (customerId != null && !customerId.equalsIgnoreCase(""))
                                    new Main2Activity.Async_getalloffline().execute(datefromcalander);
                            } catch (Exception e) {
                                Log.d("Tag", e.toString());
                            }
                        }
...
//        LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, PostRouteMapActivityCopy.this);
          ...
          if (ActivityCompat.checkSelfPermission(Main2Activity.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(Main2Activity.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED)
           {
              ...
              return;
               ...
               LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, Main2Activity.this);
           }
                        ...
                        try {
                            if (sdf.parse(datefromcalander).equals(sdf.parse(datefromrecords))) {
                                ...
                                if (cursor.getString(6) == null || cursor.getString(6).length() <= 4) {
                                    ...
                                    markerPoints.add(new MarkerData2(point, "", ""));
                                    ...
                                    decodedPolyLine = Common.decodePolyLinemapmyindia(cursor.getString(6));
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Common.showAlertDialogNOData(Main2Activity.this, "Warning!", "Check-in data not found.\n Please select another date.");
                                    }
                                });
        ...
        protected void onPostExecute(String s) {
           ...
           /* if (progressDialog.isShowing()) {
            ...
            if (decodedPolyLine == null || decodedPolyLine.size() < 1) {
                ...
                if (markerPoints != null && markerPoints.size() > 1) {
                    try {
                      /*  MarkerOptions options = new MarkerOptions();
                        ...
                        IconFactory iconFactory2 = IconFactory.getInstance(Main2Activity.this);
                ...
                mapboxMap.addPolyline(new PolylineOptions().addAll(decodedPolyLine).color(Color.parseColor("#3bb2d0")).width(5));
                ...
                /*    MarkerOptions options = new MarkerOptions();
                    ...
                    IconFactory iconFactory3 = IconFactory.getInstance(Main2Activity.this);
                    Icon icon3= iconFactory3.fromResource(R.drawable.mapbox_marker_icon_default);
                ...
                if (decodedPolyLine != null && decodedPolyLine.size() > 1) {
                    ...
                    IconFactory iconFactory4 = IconFactory.getInstance(Main2Activity.this);
                    Icon icon4 = iconFactory4.fromResource(R.drawable.mapbox_marker_icon_default);
    ...
    private class Async_getall_geotracking extends AsyncTask<Boolean, Void, String> {
                        ...
                        if (jsonData != null) {
                            try {
                                ...
                                for (int n = 0; n < companyarray.length(); n++) {
                                    ...
                                    } else if (cc.getCount() != 0 && role != Constants.Roles.ROLE_7 && !Common.getUserIdFromSP(Main2Activity.this).equalsIgnoreCase(user_id)) {
        ...
        protected void onPostExecute(String s) {
            super.onPostExecute(s);
            if (nmDays > 1)
                new Main2Activity.Async_getGeotrackingGenratedByAdmin().execute();
   ...
   /* private void rotateMarker(final Marker marker, final float toRotation) {
    ...
    private void animateMarker(MapboxMap googleMap, final Marker marker, final LatLng toPosition,
                               final boolean hideMarker) {
        final Handler handler = new Handler();
        final long start = SystemClock.uptimeMillis();
        Projection proj = googleMap.getProjection();
        PointF startPoint = proj.toScreenLocation(marker.getPosition());
            ...
            public void run() {
                ...
                if (t < 1.0) {
                    ...
                    /*if (hideMarker) {
                        ...
                        marker.setVisible(true);    //place here
                    }*/
                }
            }
        });
    ...
    public void zoomRoute(MapboxMap mapboxMap, List<LatLng> lstLatLngRoute) {
        ...
        mapboxMap.moveCamera(CameraUpdateFactory.newLatLngBounds(latLngBounds, routePadding));
    }
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (location != null) {
                ...
                if (carMarker != null && mapboxMap != null) {

                    moveMarker(carMarker, carMarker.getPosition(), new LatLng(location.getLatitude(), location.getLongitude()));
                    handleNewLocation(location, (float) mapboxMap.getCameraPosition().zoom);
                    Location location1 = new Location("");
                    location1.setLatitude(carMarker.getPosition().getLatitude());
                    location1.setLongitude(carMarker.getPosition().getLongitude());
    ...
    private void moveMarker(Marker marker, LatLng previousLatLng, LatLng currentLatLng) {
        ...
        if (previousLocation.distanceTo(currentLocation) > 10) {
            ...
            /*markerPlugin = new MarkerPlugin(mapboxMap, mapView);
            markerPlugin.icon(getResources().getDrawable(R.drawable.car_1));
            markerPlugin.addMarker(currentLatLng);
            markerPlugin.rotate(rotationValue);*/


            animateMarker(mapboxMap, marker, currentLatLng, false);

            drawPolylineWithArrowEndcap(this, mapboxMap, previousLatLng, currentLatLng);
        }
...
*/
    ...
    public Polyline drawPolylineWithArrowEndcap(Context context,
        ...
        Polyline polyline = googleMap.addPolyline(new PolylineOptions()
             /*   .geodesic(true)*/
                ...
                /*.jointType(JointType.ROUND)*/      //place here
    ...
    public void ImagepopUp(ImageView imageView, String path) {
        ...
        Picasso.with(Main2Activity.this).load(path).into(photoView_1, new com.squareup.picasso.Callback() {
            @Override
