...
public class ServiceOrderMaster {
    ...
    String serviceOrderSapId;
    String _updated_by;
    String season;
    List<ServiceOrderDetailMaster> serviceOrderDetailMasterList;

    public List<ServiceOrderDetailMaster> getServiceOrderDetailMasterListGrpByCropID() {
        return serviceOrderDetailMasterListGrpByCropID;
    }

    public void setServiceOrderDetailMasterListGrpByCropID(List<ServiceOrderDetailMaster> serviceOrderDetailMasterListGrpByCropID) {
        this.serviceOrderDetailMasterListGrpByCropID = serviceOrderDetailMasterListGrpByCropID;
    }

    List<ServiceOrderDetailMaster> serviceOrderDetailMasterListGrpByCropID;
    ...
    public ServiceOrderMaster(int id, String serviceorder_masterid, String serviceorder_type, String serviceorder_date, String serviceorder_user_id, String serviceorder_customer_id, String serviceorder_division_id, String serviceorder_company_id, String serviceorder_status, String serviceorder_cdatetime, String serviceorder_udatetime, String serviceorder_ffm_id, String created_by, String approval_status, String approval_comments, String serviceOrderSapId) {
        ...
        this.serviceOrderSapId = serviceOrderSapId;
    }
    ...
    public ServiceOrderMaster(String serviceorder_masterid, String serviceorder_type, String serviceorder_date, String serviceorder_user_id, String serviceorder_customer_id, String serviceorder_division_id, String serviceorder_company_id,
                              String serviceorder_status, String serviceorder_cdatetime, String serviceorder_udatetime, String serviceorder_ffm_id, String _token_amount, String created_by, String approval_status, String approval_comments, String serviceOrderSapId,String season) {
        this._serviceorder_masterid = serviceorder_masterid;
        this._serviceorder_type = serviceorder_type;
        this._serviceorder_date = serviceorder_date;
        this._serviceorder_user_id = serviceorder_user_id;
    ...
    public String getServiceOrderSapId() {
        return serviceOrderSapId;
    }

    public void setServiceOrderSapId(String serviceOrderSapId) {
        this.serviceOrderSapId = serviceOrderSapId;
    }
}
