...
public class PaymentActivity extends AppCompatActivity {
    ...
    Spinner spin_company, spin_customer,  spin_scheme;
    Button btn_ok;
       ...
       /* toolbar.setNavigationIcon(getResources().getDrawable(R.drawable.back));
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("auto_tv",auto_tv.getText().toString().trim()+" cc: "+customername);
                if (auto_tv.getText().toString().trim().equalsIgnoreCase(customername)) {
                    ...
                    booking.putExtra("customer_code", customercode);
                    booking.putExtra("customer_id", customerID);
                    booking.putExtra("customer_name", customername);
...
*/
    ...
    public class AsyncDivisionsoffline extends AsyncTask<String, String, String> {
          ...
          //  arlist_schemes.add(0, citieszzy);
           // adapter_schemes.add(0, "Select Distributor");
            ...
            try {
                ...
                String selectQuery = "SELECT  " + "CR." + KEY_TABLE_CUSTOMER_MASTER_ID + "," + KEY_TABLE_CUSTOMER_NAME + "," + KEY_TABLE_CUSTOMER_CODE + "," + KEY_TABLE_CUSTOMER_DETAILS_INSIDE_BUCKET + "," + KEY_TABLE_CUSTOMER_DETAILS_OUTSIDE_BUCKET + ",CR." + KEY_TABLE_CUSTOMER_CITY + " FROM " + TABLE_USER_COMPANY_CUSTOMER + " AS CDC JOIN " + TABLE_CUSTOMERS + " AS CR ON CDC." + KEY_TABLE_USER_COMPANY_CUSTOMER_CUSTOMER_ID + " = CR." + KEY_TABLE_CUSTOMER_MASTER_ID + " LEFT JOIN " + TABLE_CUSTOMER_DETAILS + " AS CD ON CD." + KEY_TABLE_CUSTOMER_DETAILS_MASTER_ID + " = CR." + KEY_TABLE_CUSTOMER_MASTER_ID + "  where " + "CDC." + KEY_TABLE_USER_COMPANY_CUSTOMER_COMPANY_ID + " = " + sel_company_id + " and " + KEY_TABLE_USER_COMPANY_CUSTOMER_USER_ID + " IN (" + team + ") and CR." + KEY_TABLE_USER_COMPANY_CUSTOMER_STATUS + " = 1 and CDC." + KEY_TABLE_USER_COMPANY_CUSTOMER_STATUS + " = 1  group by(CR." + KEY_TABLE_CUSTOMER_MASTER_ID + ")";
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        String city = cursor.getString(5) == null || cursor.getString(5).equalsIgnoreCase("null") ? "" : cursor.getString(5);
                        SelectedCities cities3 = new SelectedCities();
                        cities3.setCityId(cursor.getString(0));
                        cities3.setCityName(cursor.getString(1)+ " -" + city);
                        cities3.setCustomerCode(cursor.getString(2));
                        arlist_schemes.add(cities3);
                        adapter_schemes.add(cursor.getString(1) + " -" + city);
        ...
        protected void onPostExecute(String s) {
            ...
            autoCompleteAdapter(arlist_schemes);
/*
    ...
    public void autoCompleteAdapter(List<SelectedCities> list) {
        ...
        adapter.setOnItemClickListener(new CustomListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, SelectedCities item) {
                ...
                Common.hideSoftKeyboard(PaymentActivity.this);
...
*/
                ...
                positionDistributor = position;
                //           tv_division.setTextColor(getResources().getColor(R.color.colorPrimary));
                sel_division_id = item.getCityId();

                    customername = item.getCityName();
                    customerID = item.getCityId();
