...
import com.nsl.beejtantra.advancebooking.ViewBookings1Activity;
...
public class CropsFragmentStockMovementActivity extends AppCompatActivity implements OnAmountChangeListener {
   ...
   static class Child{
    ...
    Date            myDate;
    private         TextView tv_customername,tv_divisionname,tv_companyname,empty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emptylayout        = (LinearLayout)findViewById(R.id.layoutempty);
        ...
        tv_divisionname.setText(NewStockMovementChooseActivity.divisionname);
        tv_companyname.setText(NewStockMovementChooseActivity.companycode);
        ...
        ft = fm.beginTransaction().add(R.id.content_frame, new TabCropsStockMovemetFragment());
        ft.commit();
       ...
       /* new Async_getTokenAmount().execute();
        et_token_amount.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                for(int i = 0; i< CropsFragmentStockMovementActivity.globalGroup.size(); i++) {

                    Group  group = CropsFragmentStockMovementActivity.globalGroup.get(i);
                    if(group.isChecked){
...
/*if(total_amount>Float.parseFloat(token_amount)){
                        ...
                        try {
                            ...
                            for(int i = 0; i< CropsFragmentStockMovementActivity.globalGroup.size(); i++) {
                                List<Child> childList = CropsFragmentStockMovementActivity.globalGroup.get(i).childList;
...
*/
    ...
    public class Async_UpdateAdvancebooking extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CropsFragmentStockMovementActivity.this);
                ...
                try {
                    ...
                    for(int n = 0; n < jsonarray.length(); n++)
                    {
                        ...
                        if (status.equalsIgnoreCase("success")){
                            ...
                            AlertDialog.Builder alert = new AlertDialog.Builder(CropsFragmentStockMovementActivity.this);
    ...
    private void showAlert(String message) {
        ...
        if (!isDialogVisible) {
            alert = new AlertDialog.Builder(CropsFragmentStockMovementActivity.this);
            alert.setTitle("Info");
