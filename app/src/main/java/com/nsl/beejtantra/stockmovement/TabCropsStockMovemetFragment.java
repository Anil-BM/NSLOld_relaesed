 ...
 */
public class TabCropsStockMovemetFragment extends Fragment {

    Fragment fragment = null;
    private String userId;
    private CropsFragmentStockMovementActivity fragmentStockMovementActivity;
    private String mo_id;

    public TabCropsStockMovemetFragment() {
    ...
    public void onAttach(Activity activity) {
        super.onAttach(activity);
         fragmentStockMovementActivity=(CropsFragmentStockMovementActivity)activity;
    }
        ...
        protected String doInBackground(Void... arg0) {
           ...
           // String selectQuery = "SELECT DISTINCT CR." + KEY_TABLE_CROPS_CROP_MASTER_ID + "," + KEY_TABLE_CROPS_CROP_NAME + " FROM " + TABLE_COMPANY_DIVISION_CROPS + " AS CDC JOIN " + TABLE_CROPS + " AS CR ON CDC." + KEY_TABLE_COMPANY_DIVISION_CROPS_CROP_ID + " = CR." + KEY_TABLE_CROPS_CROP_MASTER_ID + "  where " + KEY_TABLE_COMPANY_DIVISION_CROPS_COMPANY_ID + " = " + company_id + " and " + KEY_TABLE_COMPANY_DIVISION_CROPS_DIVISION_ID + " = " + division_id;
            ...
            if (cursor.moveToFirst()) {
                do {
                    com.nsl.beejtantra.Crops crops = new Crops();
            ...
            if(Crops.size()==0) {
                ...
                Log.e("No data","no crops found!");
                fragmentStockMovementActivity.dataNotFound();
            }
            return response;
        }
    ...
    class Pagerclass extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            fragment = new NewCropsFragmentStockMovementList();
        ...
        public CharSequence getPageTitle(int position) {
            CropsFragmentStockMovementActivity.Group g = new CropsFragmentStockMovementActivity.Group();
            ...
            CropsFragmentStockMovementActivity.globalGroup.add(g);
