 ...
 */
public class TabCropsViewStockMovemetFragment extends Fragment {

    Fragment fragment = null;

    public TabCropsViewStockMovemetFragment() {
    ...
    class Pagerclass extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            fragment = new NewCropsViewFragmentStockMovementList();
