 ...
 */
public class TabCropsSalesOrderFragment extends Fragment {

    Fragment fragment = null;

    public TabCropsSalesOrderFragment() {
    ...
    class Pagerclass extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            fragment = new NewCropsFragmentSalesOrderList();
        ...
        public CharSequence getPageTitle(int position) {
            CropsFragmentSalesorderActivity.Group g = new CropsFragmentSalesorderActivity.Group();
            ...
            CropsFragmentSalesorderActivity.globalGroup.add(g);
