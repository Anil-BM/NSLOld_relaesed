...
import com.nsl.beejtantra.adapters.BankDetailsListAdapter;
...
//    private ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*tabLayout = (CustomTabLayout) findViewById(R.id.aging_tabs);
        viewPager = (ViewPager) findViewById(R.id.aging_pager);*/
                ...
                if (cursor.moveToFirst()) {
                    do {
                       ...
                       /* System.out.println("******----" + cursor.getString(0) + cursor.getString(1) + cursor.getString(2) + cursor.getString(3));
                        ...
                        map.put("inside_bucket", inside == 0 ? "0" : String.valueOf(inside));
                        map.put("outside_bucket", outside == 0 ? "0" : String.valueOf(outside));
...
//                AgingPagerAdapter agingPagerAdapter = new AgingPagerAdapter(getSupportFragmentManager(), favouriteItem);
//                tabLayout.setupWithViewPager(viewPager);
//                tabLayout.setTabsFromPagerAdapter(agingPagerAdapter);
//                viewPager.setAdapter(agingPagerAdapter);
//                viewPager.setCurrentItem(0);

                getSupportFragmentManager().beginTransaction().replace(R.id.frame_layout, new DistibutorDetailsFragment(favouriteItem, customer_id)).commit();
