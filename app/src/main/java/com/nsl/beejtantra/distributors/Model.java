...
public class Model {
    ...
    public Model(int type, String customer_id, String customer_name, String customer_code, String company_id, String company_code, String mo_name, String sap_id,String city) {
        this.type = type;
