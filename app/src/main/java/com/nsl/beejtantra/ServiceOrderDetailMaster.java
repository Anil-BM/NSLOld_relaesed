...
public class ServiceOrderDetailMaster {
	...
	String  ffmID;
	String  slabId;
	String  _serviceorderdetail_order_quantity;
	...
	public ServiceOrderDetailMaster(String serviceorderdetail_masterid,
			...
			, String ffmID, String slabId,String serviceorderdetail_order_quantity) {
		...
		this._serviceorderdetail_order_quantity = serviceorderdetail_order_quantity;
	...
	public String get_serviceorderdetail_order_quantity() {
		return _serviceorderdetail_order_quantity;
	}

	public void set_serviceorderdetail_order_quantity(String _serviceorderdetail_order_quantity) {
		this._serviceorderdetail_order_quantity = _serviceorderdetail_order_quantity;
	}
}
