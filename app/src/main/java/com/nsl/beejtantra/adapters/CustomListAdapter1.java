...
public class CustomListAdapter1 extends ArrayAdapter {
    ...
    public CustomListAdapter1(Context context, int resource, List<SelectedCities> storeDataLst) {
    ...
    public View getView(final int position, View view, @NonNull ViewGroup parent) {
        ...
        LinearLayout itemLayout = view.findViewById(R.id.item_head_layout);
        ...
        TextView taluka = view.findViewById(R.id.taluka);
        TextView mobile = view.findViewById(R.id.mobile);

        strName.setText(getItem(position).getCityName());
        if (getItem(position).isExistData()) {
            detailLayout.setVisibility(View.VISIBLE);
            district.setText(Common.isStringNull(getItem(position).getDistrict()));
            taluka.setText(Common.isStringNull(getItem(position).getTaluka()));
            mobile.setText(Common.isStringNull(getItem(position).getMobile()));
        } else {
