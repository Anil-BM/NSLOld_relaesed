package com.nsl.beejtantra.geotagging;
...
public class GeoTaggingMapActivity extends AppCompatActivity implements LocationListener, OnMapReadyCallback,
  ...
  @BindView(R.id.toolbar_title)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
      ...
      // development
       MapmyIndiaAccountManager.getInstance().setRestAPIKey("c2xjhz1dyc4rq6ssp48kdc7setcx6y6t");
        ...
        setContentView(R.layout.activity_geo_tagging_map);
    ...
    void setBtn_btnCalculateArea() {
        ...
        if (latLng != null && Common.haveInternet(this)) {
            new Async_RetailerChecking(id, type, latLng.getLatitude() + "," + latLng.getLongitude()).execute();
        }else {
  ...
  /*  @Override
    ...
    public class Async_RetailerChecking extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(GeoTaggingMapActivity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                RequestBody formBody = new FormEncodingBuilder()
                        .add("user_id", Common.getUserIdFromSP(GeoTaggingMapActivity.this))
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("success")) {
                        if (type==1) {
                            ...
                            new DatabaseHandler(GeoTaggingMapActivity.this).updateTable(DatabaseHandler.TABLE_CUSTOMERS, contentValues, DatabaseHandler.KEY_TABLE_CUSTOMER_MASTER_ID, id);
                        }else if (type==2){
                            ContentValues contentValues = new ContentValues();
                            contentValues.put(DatabaseHandler.KEY_TABLE_CUSTOMER_LAT_LNG, latLng);
                            new DatabaseHandler(GeoTaggingMapActivity.this).updateTable(DatabaseHandler.TABLE_RETAILER, contentValues, DatabaseHandler.KEY_TABLE_RETAILER_MASTER_ID, id);

                        }

                        AlertDialog.Builder builder = new AlertDialog.Builder(GeoTaggingMapActivity.this);
