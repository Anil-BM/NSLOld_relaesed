...
import com.nsl.beejtantra.NewViewStockMovementChooseActivity;
...
import com.nsl.beejtantra.advancebooking.TabCropsAdvanceBookingFragment;
...
public class CropsFragmentViewStockReturnsActivity extends AppCompatActivity implements OnAmountChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft = fm.beginTransaction().add(R.id.content_frame, new TabCropsViewStockReturnsFragment());
        ft.commit();
        ...
        et_token_amount.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                for (int i = 0; i < CropsFragmentViewStockReturnsActivity.globalGroup.size(); i++) {

                    Group group = CropsFragmentViewStockReturnsActivity.globalGroup.get(i);
                    if (group.isChecked) {
            ...
            public void onClick(View view) {
                ...
                if (token_amount.length() == 0) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < CropsFragmentViewStockReturnsActivity.globalGroup.size(); i++) {
                            List<Child> childList = CropsFragmentViewStockReturnsActivity.globalGroup.get(i).childList;
    ...
    public class Async_UpdateAdvancebooking extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CropsFragmentViewStockReturnsActivity.this);
                ...
                try {
                    ...
                    for (int n = 0; n < jsonarray.length(); n++) {
                        ...
                        if (status.equalsIgnoreCase("success")) {
                            ...
                            AlertDialog.Builder alert = new AlertDialog.Builder(CropsFragmentViewStockReturnsActivity.this);
    ...
    private void showAlert(String message) {
        ...
        if (!isDialogVisible) {
            alert = new AlertDialog.Builder(CropsFragmentViewStockReturnsActivity.this);
            alert.setTitle("Info");
