 ...
 */
public class TabCropsViewStockReturnsFragment extends Fragment {

    Fragment fragment = null;

    public TabCropsViewStockReturnsFragment() {
    ...
    class Pagerclass extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            fragment = new NewCropsViewFragmentStockReturnsList();
