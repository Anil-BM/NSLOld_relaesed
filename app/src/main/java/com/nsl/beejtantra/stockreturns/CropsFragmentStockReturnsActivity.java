...
public class CropsFragmentStockReturnsActivity extends AppCompatActivity implements OnAmountChangeListener {
   ...
   static class Child{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_divisionname.setText(NewStockReturnsChooseActivity.divisionname);
        tv_companyname.setText(NewStockReturnsChooseActivity.companycode);
        ...
        ft = fm.beginTransaction().add(R.id.content_frame, new TabCropsStockReturnsFragment());
        ft.commit();
...
/*
        ...
        et_token_amount.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                for(int i = 0; i< CropsFragmentStockReturnsActivity.globalGroup.size(); i++) {

                    Group  group = CropsFragmentStockReturnsActivity.globalGroup.get(i);
                    if(group.isChecked){
                ...
                if(token_amount.length()==0 ){
                    ...
                    *//*if(total_amount>Float.parseFloat(token_amount)){
                        ...
                        try {
                            ...
                            for(int i = 0; i< CropsFragmentStockReturnsActivity.globalGroup.size(); i++) {
                                List<Child> childList = CropsFragmentStockReturnsActivity.globalGroup.get(i).childList;
    ...
    public class Async_UpdateAdvancebooking extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CropsFragmentStockReturnsActivity.this);
                ...
                try {
                    ...
                    for(int n = 0; n < jsonarray.length(); n++)
                    {
                        ...
                        if (status.equalsIgnoreCase("success")){
                            ...
                            AlertDialog.Builder alert = new AlertDialog.Builder(CropsFragmentStockReturnsActivity.this);
    ...
    private void showAlert(String message) {
        ...
        if (!isDialogVisible) {
            alert = new AlertDialog.Builder(CropsFragmentStockReturnsActivity.this);
            alert.setTitle("Info");
