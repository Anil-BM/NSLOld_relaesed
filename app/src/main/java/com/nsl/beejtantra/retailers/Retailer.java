...
public class Retailer {
    ...
    String _ret_tin_no;
    String _ret_address;
    String _ret_district;
    String _ret_taluka;
    String _ret_village;
    String _ret_gstin_no;
    String _ret_region_id;
    String _ret_phone;
    String _ret_mobile;
    ...
    public Retailer(int id,
        ...
        this._ret_district = ret_district;
        this._ret_taluka = ret_taluka;
        this._ret_village = ret_village;
        this._ret_region_id = ret_region_id;
        this._ret_gstin_no = ret_gstin_no;
    ...
    public String get_ret_district() {
        return _ret_district;
    }

    public void set_ret_district(String _ret_district) {
        this._ret_district = _ret_district;
    }

    public String get_ret_taluka() {
        return _ret_taluka;
    }

    public void set_ret_taluka(String _ret_taluka) {
        this._ret_taluka = _ret_taluka;
    }

    public String get_ret_village() {
        return _ret_village;
    }

    public void set_ret_village(String _ret_village) {
        this._ret_village = _ret_village;
    }

    public String get_ret_gstin_no() {
        return _ret_gstin_no;
    }

    public void set_ret_gstin_no(String _ret_gstin_no) {
        this._ret_gstin_no = _ret_gstin_no;
    }

    public String get_ret_region_id() {
        return _ret_region_id;
    }

    public void set_ret_region_id(String _ret_region_id) {
        this._ret_region_id = _ret_region_id;
    }
}
