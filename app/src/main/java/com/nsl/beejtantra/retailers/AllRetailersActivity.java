...
import com.nsl.beejtantra.adapters.RetailerListAdapter;
import com.nsl.beejtantra.adapters.StockPlacementPopupListAdapter;
import com.nsl.beejtantra.commonutils.Common;
import com.nsl.beejtantra.enums.RoleEnum;
import com.nsl.beejtantra.multiselectionlist.TeamListViewAdapter;
...
//                startActivity(home);
        ...
        if (getIntent().getStringExtra("stock_placed") != null) ;
        distStockPlaced = Integer.parseInt(getIntent().getStringExtra("stock_placed"));
        sharedpreferences = getSharedPreferences(mypreference, Context.MODE_PRIVATE);
        ...
        mappedRetailerData = db.getMappedRetailerWithDistributorCropProduct(customer_id, product_id, crop_id);
...
*/
        ...
        if (mappedRetailerPojos.size() != 0) {
            ...
            retailerListAdapter.setOnItemClickListener(new RetailerListAdapter.OnItemClickListener() {
                ...
                public void onItemClick(View view, final int position) {
                    ...
                    final TextView stockPlaced = (TextView) view.findViewById(R.id.TextView_stockplaced);
                    ...
                    switch (view.getId()) {
                        ...
                        case R.id.TextView_stockplaced:
                            ...
                            dialog.findViewById(R.id.stock_entry_layout).setVisibility(View.VISIBLE);
                            ...
                            crop_name.setText(Common.isStringNull(product_name));
                            stockPlacementPopupPojoArrayList = db.getRetailerStockSupplyItems(customer_id, crop_id, product_id, mappedRetailerPojos.get(position).retailerId);
                            ...
                            ok.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    for (int i = 0; i < mappedRetailerPojos.size(); i++) {
                                        if (i == position)
                                            qtyCount += qty;
                                        else
                                            qtyCount += Integer.parseInt(Common.isStringNull(mappedRetailerPojos.get(i).stockPlaced).length() == 0 ? "0" : mappedRetailerPojos.get(i).stockPlaced);
                                    }
                                    if (qtyCount > distStockPlaced) {
                                        qnty_places.requestFocus();
                                        qnty_places.setError("Stock Placed Count lower than or equal to Product level Stock Placed");
                                        return;
                                    }
                                    ...
                                    setStockPlacedListOnAdapter(db.getRetailerStockSupplyItems(customer_id,crop_id, product_id, mappedRetailerPojos.get(position).retailerId), recyclerViewStockPlacement);
                        ...
                        case R.id.TextView_current_stock:
                            ...
                            final TextView crop_name1 = (TextView) dialog1.findViewById(R.id.crop_name);
                            ...
                            crop_name1.setText(Common.isStringNull(product_name));
                            ...
                            ok1.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (qnty_places1.getText().toString().trim().length() == 0) {
                                        qnty_places1.requestFocus();
                                        qnty_places1.setError("Please Enter Quantity");
                                        return;
                                    }
                                    int qty = Integer.parseInt(qnty_places1.getText().toString().trim());
                                    if (qty > Integer.parseInt(stockPlaced.getText().toString().trim())) {
                                        qnty_places1.requestFocus();
                                        qnty_places1.setError("Current Stock must be lower than or equal to Stock Placed");
                                        return;
                                    }
    ...
    private boolean saveStockMovementInDb(String date, String stockPlacedQuantity, String currentStockQuantity, String productId, String retailerId) {
        if (!date.equalsIgnoreCase("") && (!stockPlacedQuantity.equalsIgnoreCase("") || !currentStockQuantity.equalsIgnoreCase(""))) {
          ...
          /*  StockMovementPoJo stockMovementPoJo = new StockMovementPoJo();
            ...
            RetailerStockSupply retailerStockSupply = new RetailerStockSupply();
            retailerStockSupply.cropId = crop_id;
            retailerStockSupply.distributerId = customer_id;
            retailerStockSupply.productId = productId;
            retailerStockSupply.quantity = stockPlacedQuantity;
            retailerStockSupply.retailerId = retailerId;
            retailerStockSupply.suppliedDate = date;
            retailerStockSupply.stockSupplyId = "0";
            retailerStockSupply.userId = userId;
            db.insertRetailerStockSupply(retailerStockSupply);
    ...
    private void prepareStockMovementDataAndPush() {
       /* mainArray = new JSONArray();
        ...
        String json = new Gson().toJson(retailerStockReqVo);
        Common.Log.i("Json "+json);
