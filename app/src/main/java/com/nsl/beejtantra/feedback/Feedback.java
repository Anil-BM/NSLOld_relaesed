...
public class Feedback {
    ...
    // constructor
    public Feedback(int id, int user_id, String farmer_name, String place, String contact_no, String crop, String hybrid, String sowing_date, String feedback_message, String image, String ffmid, String transplantingDate) {
    ...
    // constructor
    public Feedback(int user_id, String farmer_name, String place, String contact_no, String crop, String hybrid, String sowing_date, String feedback_message, String image, String ffmid, String transplantingDate) {
        this._user_id = user_id;
        this._farmer_name = farmer_name;
        this._place = place;
        this._contact_no = contact_no;
