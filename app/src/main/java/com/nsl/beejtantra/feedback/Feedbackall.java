...
import com.nsl.beejtantra.complaints.AllproductsActivity;
...
public class Feedbackall extends AppCompatActivity {
    TextView tv_fbk, tv_name, tv_place, tv_contact, tv_crop, tv_hybrid, tv_sowing_date, tv_trans_date, tv_image;
    ImageView img;
    String imgfile;
...
//                startActivity(home);
        ...
        String trans_date = getIntent().getExtras().getString("trans_date", "");
        if (trans_date.length() == 0) {
            tv_trans_date.setText("");
        } else {
            tv_trans_date.setText(Common.setDateFormateOnTxt(trans_date.split(" ")[0]));
        }
                        ...
                        if (imgfile.length() > 0) {
                            ...
                            for (int i = 0; i < images.length; i++) {
                                ...
                                imageViewsAll[i].setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent imageIntent = new Intent(Feedbackall.this, SimpleImageActivity.class);
