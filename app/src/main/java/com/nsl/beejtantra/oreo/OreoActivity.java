...
import com.nsl.beejtantra.BuildConfig;
 ...
 */
public class OreoActivity extends AppCompatActivity implements
        SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = OreoActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.oreo_main);
       ...
       // mRemoveLocationUpdatesButton.setEnabled(true);
        ...
        mRequestLocationUpdatesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!checkPermissions()) {
                    ...
                    mService.requestLocationUpdates(4);
                   /* FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(new GooglePlayDriver(OreoActivity.this));
                    Job myJob = dispatcher.newJobBuilder()
                            .setService(LocationUpdatesService.class)
                            .setLifetime(Lifetime.FOREVER)
                            .setRecurring(true)
                            .setReplaceCurrent(true)
                            .setTrigger(Trigger.executionWindow(5,10))// the JobService that will be called
        ...
        mRemoveLocationUpdatesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               /* FirebaseJobDispatcher dispatcher = new FirebaseJobDispatcher(new GooglePlayDriver(OreoActivity.this));
                Job myJob = dispatcher.newJobBuilder()
                        .setService(LocationUpdatesService.class) // the JobService that will be called
                        .setTag("my-unique-tag")        // uniquely identifies the job
                        .build();
        ...
        if (shouldProvideRationale) {
            ...
            Snackbar.make(
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(OreoActivity.this,
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (location != null) {
                Toast.makeText(OreoActivity.this, Utils.getLocationText(location),
