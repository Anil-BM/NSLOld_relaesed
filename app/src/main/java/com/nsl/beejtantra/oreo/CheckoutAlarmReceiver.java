...
import static com.nsl.beejtantra.commonutils.Common.getCurrentDateYYYYMMDD;
    ...
    private void turnOnScreen(Context context) {
        ...
        if ((context.getSystemService(POWER_SERVICE)) != null) {
            screenLock = ((PowerManager) context.getSystemService(POWER_SERVICE)).newWakeLock(
                    PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "myapp:mywakelockTAG1");
