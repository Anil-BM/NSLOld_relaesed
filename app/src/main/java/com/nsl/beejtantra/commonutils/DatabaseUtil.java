...
public class DatabaseUtil {
    ...
    final static String DATABASE_NAME = "NSL.db";
    //example WhatsApp :  /data/data/com.whatsapp/databases/msgstore.db
    public final static String FOLDER_EXTERNAL_DIRECTORY = Environment.getExternalStorageDirectory() + "/NSL";
