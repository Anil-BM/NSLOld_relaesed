...
public class Employe_visit_management_pojo {
    ...
    private String _emp_visit_crop_id;
    String _emp_visit_region_id;
    //private variables
    int _emp_v_id;
    ...
    String _emp_visit_retailer_id;
    String _emp_visit_farmer_id;
    int _emp_visit_mobile;
    String _emp_visit_village;
    String _emp_visit_locationaddress;
    String _emp_visit_locationdistrict;
    String _emp_visit_locationtaluka;
    String _emp_visit_locationvillage;
    String _emp_visit_gstinno;
    ...
    public Employe_visit_management_pojo(int id, String emp_visit_master_id,
                                         ...
                                         String emp_visit_crop_id,
                                         String _emp_visit_region_id,
                                         String emp_visit_locationdistrict,
                                         String emp_visit_locationtaluka,
                                         String _emp_visit_locationvillage,
                                         String _emp_visit_gstinno,
                                         ...
                                         int emp_visit_ffm_id, int serverFlag) {
        ...
        this._emp_visit_retailer_id = _emp_visit_retailer_id;
        this._emp_visit_farmer_id = _emp_visit_farmer_id;
        ...
        this._emp_visit_crop_id = emp_visit_crop_id;
        this._emp_visit_region_id = _emp_visit_region_id;
        this._emp_visit_locationdistrict = emp_visit_locationdistrict;
        this._emp_visit_locationtaluka = emp_visit_locationtaluka;
        this._emp_visit_locationvillage = _emp_visit_locationvillage;
        this._emp_visit_gstinno = _emp_visit_gstinno;
    ...
    public Employe_visit_management_pojo(
        ...
        this._emp_visit_locationdistrict = emp_visit_locationdistrict;
        this._emp_visit_crop_id = emp_visit_crop_id;
        this._emp_visit_region_id = emp_visit_region_id;
        this._emp_visit_locationtaluka = emp_visit_locationtaluka;
        this._emp_visit_locationvillage = _emp_visit_locationvillage;
        this._emp_visit_gstinno = _emp_visit_gstinno;
        this._emp_visit_fieldarea = emp_visit_fieldarea;
   ...
   /* public Employe_visit_management_pojo(
    ...
    public String get_emp_visit_locationdistrict() {
        return _emp_visit_locationdistrict;
    }

    public void set_emp_visit_locationdistrict(String _emp_visit_locationdistrict) {
        this._emp_visit_locationdistrict = _emp_visit_locationdistrict;
    }

    public String get_emp_visit_locationtaluka() {
        return _emp_visit_locationtaluka;
    }

    public void set_emp_visit_locationtaluka(String _emp_visit_locationtaluka) {
        this._emp_visit_locationtaluka = _emp_visit_locationtaluka;
    }

    public String get_emp_visit_locationvillage() {
        return _emp_visit_locationvillage;
    }

    public void set_emp_visit_locationvillage(String _emp_visit_locationvillage) {
        this._emp_visit_locationvillage = _emp_visit_locationvillage;
    }

    public String get_emp_visit_gstinno() {
        return _emp_visit_gstinno;
    }

    public void set_emp_visit_gstinno(String _emp_visit_gstinno) {
        this._emp_visit_gstinno = _emp_visit_gstinno;
    }

    public String get_emp_visit_region_id() {
        return _emp_visit_region_id;
    }

    public void set_emp_visit_region_id(String _emp_visit_region_id) {
        this._emp_visit_region_id = _emp_visit_region_id;
    }

    public String get_emp_visit_retailer_id() {
        return _emp_visit_retailer_id;
    }

    public void set_emp_visit_retailer_id(String _emp_visit_retailer_id) {
        this._emp_visit_retailer_id = _emp_visit_retailer_id;
    }

    public String get_emp_visit_farmer_id() {
        return _emp_visit_farmer_id;
    }

    public void set_emp_visit_farmer_id(String _emp_visit_farmer_id) {
        this._emp_visit_farmer_id = _emp_visit_farmer_id;
    }

    public String get_emp_visit_crop_id() {
        return _emp_visit_crop_id;
    }

    public void set_emp_visit_crop_id(String _emp_visit_crop_id) {
        this._emp_visit_crop_id = _emp_visit_crop_id;
    }
