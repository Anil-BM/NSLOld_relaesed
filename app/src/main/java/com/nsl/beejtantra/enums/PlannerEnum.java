...
package com.nsl.beejtantra.enums;
...

{
    ...
    INDIVIDUAL_FARMER_MEETING(13, "Individual Farmer Meeting", new int[]{3}),
    FIELD_DAY_PLANNING(14, "Field Day Planning", new int[]{3}),
    FIELD_DAY(15, "Field Day", new int[]{3}),
    GROUP_MEETING(16, "Group Meeting", new int[]{3}),
    PROMOTIONAL_ACTIVITY(17, "Promotional Activity", new int[]{3}),
    OTHER(12, "Other", new int[]{1, 2, 3});
