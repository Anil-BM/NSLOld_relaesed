...
public class Customer_Bank_Details {
    ...
    // constructor
    public Customer_Bank_Details(int cust_bank_dtls_id,
                                 String cus_bak_dtls_masterid,
                                 String customer_id,
                                 String account_no ,
                                 String account_name ,
                                 String bank_name,
        ...
        this._cust_bank_dtls_id          = cust_bank_dtls_id;
    ...
    public Customer_Bank_Details(
    ) {
    }

    public Customer_Bank_Details(String cus_bak_dtls_masterid,
                                 String customer_id,
                                 String account_no ,
                                 String account_name ,
                                 String bank_name,
                                 String branch_name,
                                 String ifsc_code,
                                 String status,String created_by,String updated_by,String created_date,String ffmid
    ){
    ...
    public void setID(int cust_bank_dtls_id){
        this._cust_bank_dtls_id = cust_bank_dtls_id;
    }
